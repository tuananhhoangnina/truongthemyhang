			...
			var filterConfig = function (data) {
				return function findMatches(q, cb) {
					...
					data.filter(function (i) {
						if (
							(i.namevi && i.namevi.toLowerCase().startsWith(q.toLowerCase())) || 
							(i.slugvi && i.slugvi.toLowerCase().startsWith(q.toLowerCase()))
						) {
							matches.push(i);
						} else if (
							(i.namevi && !i.namevi.toLowerCase().startsWith(q.toLowerCase()) && i.namevi.toLowerCase().includes(q.toLowerCase())) || 
							(i.slugvi && !i.slugvi.toLowerCase().startsWith(q.toLowerCase()) && i.slugvi.toLowerCase().includes(q.toLowerCase()))
						) {
							matches.push(i);
