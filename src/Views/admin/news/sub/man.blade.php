            ...
            <table class="datatables-category-list table border-top text-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            @component('component.name',['config'=>$configMan->categories->sub,'name'=>$v['namevi'],'slug'=>$v['slugvi'],'params'=>['id'=>$v['id'],'id_list'=>$v['id_list'],'id_cat'=>$v['id_cat'],'id_item'=>$v['id_item']]])
                            @endcomponent
