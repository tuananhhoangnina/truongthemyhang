...
return [
	...
	*/
	...
	'stack_traces' => [
		...
		'skip_classes' => [
			// App\CustomLog::class
			// 'NINACORE\Core\View\View',
			// 'NINACORE\DatabaseCore\Query\Builder',
			// 'NINACORE\DatabaseCore\Eloquent\Builder',
			// 'NINACORE\DatabaseCore\Eloquent\Relations\Relation',
			// 'NINACORE\DatabaseCore\Connection',
			// 'NINACORE\Helpers\Clockwork\Datasource\EloquentDataSource',
			// 'NINACORE\Core\App',
			// 'NINACORE\Core\Routing\ClassLoaderCustom',
		]
	...
	*/
	...
	'serialization_blackbox' => [
		...
		\NINACORE\Core\Container::class,
		\NINACORE\Core\Routing\NINARouter::class,
		\NINACORE\Core\App::class,
	],
