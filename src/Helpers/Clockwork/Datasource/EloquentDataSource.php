...
use NINACORE\DatabaseCore\DatabaseManager;
use NINACORE\DatabaseCore\Eloquent\MissingAttributeException;
use NINACORE\DatabaseCore\Eloquent\Model;
use NINACORE\DatabaseCore\Events\QueryExecuted;
use NINACORE\DatabaseCore\Events\TransactionBeginning;
use NINACORE\DatabaseCore\Events\TransactionCommitted;
use NINACORE\DatabaseCore\Events\TransactionRolledBack;
use NINACORE\Helpers\Clockwork\Eloquent\ResolveModelScope;
